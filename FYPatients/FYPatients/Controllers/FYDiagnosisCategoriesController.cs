...
{
    public class FYDiagnosisCategoriesController : Controller
    {
        private readonly PatientsContext _context;

        public FYDiagnosisCategoriesController(PatientsContext context)
        {
            _context = context;
        }

        // GET: FYDiagnosisCategories
        public async Task<IActionResult> Index()
        {
            return View(await _context.DiagnosisCategory.ToListAsync());
        }

        // GET: FYDiagnosisCategories/Details/5
        ...
        // GET: FYDiagnosisCategories/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: FYDiagnosisCategories/Create
        ...
        // GET: FYDiagnosisCategories/Edit/5
        ...
        // POST: FYDiagnosisCategories/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: FYDiagnosisCategories/Delete/5
        ...
        // POST: FYDiagnosisCategories/Delete/5
