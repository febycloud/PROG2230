...
{
    public class FYCountriesController : Controller
    {
        private readonly PatientsContext _context;

        public FYCountriesController(PatientsContext context)
        {
            _context = context;
        }
        ...
        // GET: FYCountries/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: FYCountries/Create
